    ...
    <div id="features" class="py-6 px-6 lg:px-20 mt-8 mx-0 lg:mx-20">
        <div class="grid grid-cols-12 gap-4 justify-center">
            <div class="col-span-12 text-center mt-20 mb-6">
                <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Nossos Cursos</div>
                <span class="text-muted-color text-2xl">Conheça as formações que preparamos para o seu sucesso.</span>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <h5 class="mb-2 text-surface-900 dark:text-surface-0">Administração</h5>
                        <span class="text-surface-600 dark:text-surface-200">Aprenda a gerenciar empresas,
                            lidera...</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <h5 class="mb-2 text-surface-900 dark:text-surface-0">Engenharia Informática</h5>
                        <span class="text-surface-600 dark:text-surface-200">Desenvolva habilidades em programação,
                            rede...</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Enfermagem
                        </div>
                        <span class="text-surface-600 dark:text-surface-200">Forme-se para cuidar da saúde e bem-estar
                            das pessoas, atuan...</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Engenharia
                            Civil</div>
                        <span class="text-surface-600 dark:text-surface-200">Projete, planeje e construa obras que
                            transformam cidad...</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Contabilidade
                            e Finanças</div>
                        <span class="text-surface-600 dark:text-surface-200">Domine as técnicas de gestão financeira,
                            auditoria e aná....</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Design Gráfico
                        </div>
                        <span class="text-surface-600 dark:text-surface-200">Crie identidades visuais, layouts e
                            experiências visua...</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Hotelaria e
                            Turismo</div>
                        <span class="text-surface-600 dark:text-surface-200">Atue em hotéis, resorts e agências,
                            proporcionan...</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Ciências
                            Biológicas</div>
                        <span class="text-surface-600 dark:text-surface-200">Estude os seres vivos, seus ecossistemas e
                            contribua para pesquis...</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg-4 mt-6 lg:mt-0">
                <div
                    ...
                    <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                        ...
                        <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Direito</div>
                        <span class="text-surface-600 dark:text-surface-200">Compreenda as leis, atue na defesa de
                            direitos e traba...</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 mt-20 mb-20 p-2 md:p-20"
                ...
                <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
                    <div class="text-gray-900 mb-2 text-3xl font-semibold">Sobre Nós</div>
                    <!-- <span class="text-gray-600 text-2xl">Peak Interactive</span> -->
                    <p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-6" style="max-width: 800px">
                        Somos uma instituição dedicada à formação de profissionais capacitados, comprometida com a
                        excelência acadêmica e o desenvolvimento humano.
                        Ao longo dos anos, construímos uma trajetória marcada por inovação, qualidade de ensino e
