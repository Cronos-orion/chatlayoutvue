                ...
                <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                    <div class="col-span-12 md:col-span-3">
                        <h4 class="font-medium text-2xl leading-normal mb-4 text-surface-900 dark:text-surface-0">
                            Empresa</h4>
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Sobre
                            Nós</a>
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Notícias</a>
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Relações
                            com Investidores</a>
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Carreiras</a>
                        <a class="leading-normal text-xl block cursor-pointer text-surface-700 dark:text-surface-100">Kit
                            de Imprensa</a>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-3">
                        <h4 class="font-medium text-2xl leading-normal mb-4 text-surface-900 dark:text-surface-0">
                            Recursos</h4>
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Comece
                            Aqui</a>
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Aprenda</a>
                        <a class="leading-normal text-xl block cursor-pointer text-surface-700 dark:text-surface-100">Estudos
                            de Caso</a>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-3">
                        ...
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Eventos
                            <img src="/demo/images/landing/new-badge.svg" class="ml-2" /></a>
                        <a
                    ...
                    <div class="col-span-12 md:col-span-3">
                        ...
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Política
                            da Marca</a>
                        <a
                            class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Política
                            de Privacidade</a>
                        <a class="leading-normal text-xl block cursor-pointer text-surface-700 dark:text-surface-100">Termos
                            de Serviço</a>
                    </div>
                </div>
